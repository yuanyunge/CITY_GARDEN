<template>
    <div class="main_box_2">
        ...
        <div class="main_box_2_2 mapArea">
           <div class="dataMapContainer" id="lishuiMap" ref="dataMapBox"></div>
        </div>
    </div>
</template>
<script>
...
export default {
  ...
  mounted() {
    this.$nextTick(function () {
      ...
      this.initChart();
      let resizeFun=window.onresize||function(){};
      window.onresize =  ()=>{
        resizeFun();
        this.myChart.resize();
      };
  ...
  methods: {
    ...
    initMapSeriesData: function (curMapData) {
      ...
      for (let key in mapjson.features) {
